...
const translations = {
  en: {
    ...
    editsWelcome: "WELCOME TO",
    editsMainTitle: "MY EDITS",
    editsSubtext: "Videos and graphics for Gavi here",
    editsHeroBtn: "FEATURED EDITS",
    editsHeroKicker: "EDITS BY GHF",
    editsHeroTitle: "My edits for Gavi",
    editsHeroSubtitle: "Videos and graphics made with love for the best midfielder.",
    editsSectionTitle: "Featured edits",
    edit1Name: "We are back",
    edit1Desc: "Gavi Huge Fan account is back! Celebrating with the crew and the gorilla — a moment that started it all again.",
    edit2Name: "Today's edit",
    edit2Desc: "A fresh cut from training and matchday — Gavi's intensity and passion in every frame.",
    edit3Name: "Pedri × Gavi collage",
    edit3Desc: "The duo that defines Barça's midfield. This collage hit the top for a reason — two friends, one dream.",
    editTagImage: "Image",
    editTagVideo: "Video",
    ...
    awardsKicker: "AWARDS & HONORS",
    awardsTitle: "Trophies & milestones",
    awardsSubtitle: "From Golden Boy to the world stage — the accolades that define his rise.",
    awardYear1: "2022",
    awardName1: "Golden Boy",
    awardDesc1: "Best U21 player in Europe",
    awardYear2: "2022",
    awardName2: "Kopa Trophy",
    awardDesc2: "Best U21 at Ballon d'Or",
    awardYear3: "2022–23 & 2024–25",
    awardName3: "La Liga",
    awardDesc3: "Two-time champion with Barcelona",
    awardYear4: "2023",
    awardName4: "UEFA Nations League",
    awardDesc4: "Winner with Spain",
    awardYear5: "2022",
    awardName5: "World Cup goalscorer",
    awardDesc5: "Youngest Spain scorer at Qatar 2022",
    awardYear6: "2021–",
    awardName6: "Barça first team",
    awardDesc6: "One of the youngest debutants ever",
    awardYear7: "2022–23, 2024–25, 2025–26",
    awardName7: "Spanish Super Cup",
    awardDesc7: "Three-time winner with Barcelona",
    awardYear8: "2024–25",
    awardName8: "Spanish Cup",
    awardDesc8: "Copa del Rey winner with Barcelona",

    quotesKicker: "WHAT THEY SAY",
    quotesTitle: "About Gavi",
    quotesSubtitle: "Coaches, teammates and the football world on Pablo.",
    quoteText1: "\"Gavi has a heart the size of a planet. He plays with the courage and intensity that define this club.\"",
    quoteName1: "Xavi Hernández",
    quoteRole1: "Barça coach",
    quoteText2: "\"He is unique. There is no one like him. The way he competes, the personality — he is the future of Spanish football.\"",
    quoteName2: "Luis Enrique",
    quoteRole2: "Former Spain coach",
    quoteText3: "\"Playing next to him is easy. He always wants the ball, he never hides, and he makes everyone around him better.\"",
    quoteName3: "Pedri",
    quoteRole3: "Teammate, Barcelona & Spain",
    quoteText4: "\"Gavi is not the next anyone. He is something new. The intensity, the character — you don't teach that.\"",
    quoteName4: "La Masia staff",
    quoteRole4: "FC Barcelona academy"
  },
  ...
  es: {
    ...
    editsWelcome: "BIENVENIDO A",
    editsMainTitle: "MIS EDICIONES",
    editsSubtext: "Vídeos y gráficos de Gavi aquí",
    editsHeroBtn: "EDICIONES DESTACADAS",
    editsHeroKicker: "EDITS POR GHF",
    editsHeroTitle: "Mis ediciones de Gavi",
    editsHeroSubtitle: "Vídeos y gráficos hechos con cariño para el mejor mediocampista.",
    editsSectionTitle: "Ediciones destacadas",
    edit1Name: "Estamos de vuelta",
    edit1Desc: "¡La cuenta Gavi Huge Fan ha vuelto! Celebrando con el equipo y el gorila — el momento que lo inició todo de nuevo.",
    edit2Name: "Edición de hoy",
    edit2Desc: "Un corte fresco de entrenamiento y partido — la intensidad y pasión de Gavi en cada plano.",
    edit3Name: "Collage Pedri × Gavi",
    edit3Desc: "El dúo que define el mediocampo del Barça. Este collage llegó arriba por algo — dos amigos, un sueño.",
    editTagImage: "Imagen",
    editTagVideo: "Vídeo",
    ...
    awardsKicker: "PREMIOS Y HONORES",
    awardsTitle: "Trofeos y hitos",
    awardsSubtitle: "Del Golden Boy al escenario mundial — los reconocimientos que marcan su ascenso.",
    awardYear1: "2022",
    awardName1: "Golden Boy",
    awardDesc1: "Mejor sub-21 de Europa",
    awardYear2: "2022",
    awardName2: "Trofeo Kopa",
    awardDesc2: "Mejor sub-21 en el Balón de Oro",
    awardYear3: "2022–23 y 2024–25",
    awardName3: "La Liga",
    awardDesc3: "Bicampeón con el Barcelona",
    awardYear4: "2023",
    awardName4: "UEFA Nations League",
    awardDesc4: "Campeón con España",
    awardYear5: "2022",
    awardName5: "Goleador en el Mundial",
    awardDesc5: "El goleador más joven de España en Qatar 2022",
    awardYear6: "2021–",
    awardName6: "Primer equipo del Barça",
    awardDesc6: "Uno de los debutantes más jóvenes de la historia",
    awardYear7: "2022–23, 2024–25, 2025–26",
    awardName7: "Supercopa de España",
    awardDesc7: "Tricampeón con el Barcelona",
    awardYear8: "2024–25",
    awardName8: "Copa del Rey",
    awardDesc8: "Campeón de Copa con el Barcelona",

    quotesKicker: "LO QUE DICEN",
    quotesTitle: "Sobre Gavi",
    quotesSubtitle: "Entrenadores, compañeros y el mundo del fútbol hablan de Pablo.",
    quoteText1: "\"Gavi tiene un corazón del tamaño de un planeta. Juega con el coraje y la intensidad que definen este club.\"",
    quoteName1: "Xavi Hernández",
    quoteRole1: "Entrenador del Barça",
    quoteText2: "\"Es único. No hay nadie como él. La forma de competir, la personalidad — es el futuro del fútbol español.\"",
    quoteName2: "Luis Enrique",
    quoteRole2: "Exseleccionador español",
    quoteText3: "\"Jugar a su lado es fácil. Siempre pide el balón, no se esconde nunca y hace mejorar a todos.\"",
    quoteName3: "Pedri",
    quoteRole3: "Compañero, Barcelona y España",
    quoteText4: "\"Gavi no es el siguiente de nadie. Es algo nuevo. La intensidad, el carácter — eso no se enseña.\"",
    quoteName4: "Personal de La Masia",
    quoteRole4: "Cantera del FC Barcelona"
  }
};
